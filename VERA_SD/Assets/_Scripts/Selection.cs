...
public class Select : MonoBehaviour
{
    ...
    {
        // Honestly a suspicious way of doing this: Get all objs in radius > Loop through and find all objs with ISelectable
        ...
        {
            if (collider.gameObject.GetComponent<ISelectable>() != null)
