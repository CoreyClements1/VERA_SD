...
public class LockedDoor : MonoBehaviour
{
    ...
    [SerializeField] private VLAT_DefaultInteractions leftDoor;
    [SerializeField] private VLAT_DefaultInteractions rightDoor;
    ...
    //--------------------------------------//
    {
        if (!locked)
        {
            leftDoor.DoorOpenAndClose();
            rightDoor.DoorOpenAndClose();
        }
        else
        {
